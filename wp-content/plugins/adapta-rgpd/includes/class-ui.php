...
<script type="text/javascript" >			
	...
	public function argpd_paginas_content() {
		...
		<form method="post" action="admin-post.php">
			...
			<br><br>
			<div class="argpd-panel">
				<h2 class="title"><?php esc_html_e( 'Primera capa informativa', 'argpd' ); ?></h2>
				<p>
							...
							<tr>
								...
								<td>
									...
									<!--<textarea 
										...
										cols="60"
										rows="3"
										placeholder="Esta web utiliza cookies propias para su correcto funcionamiento..."
			...
			<div class="argpd-panel">
				...
				<table class="form-table">
					<tbody>	
						...
						<tr>
							<th scope="row">
								<label for="cookies-linklabel"><?php
								printf(
									'%s<br>%s',
	...
	public function options_ui() {
		...
		<div class="wrap">		
			...
			<p style="font-size: 1.1em">
				Tu valoración de <span><b><a href="https://wordpress.org/support/plugin/adapta-rgpd/reviews?rate=5#new-post">★★★★★</a></b></span>&nbsp; ayuda a mejorar el plugin
			</p
